...
export function TopBar({ title, onBack, right, iconSize = 22, tone = 'cream', }) {
    ...
    return (_jsxs("div", { className: "flex items-center justify-between px-4 h-12 sticky top-0 z-10", style: { backgroundColor: bg }, children: [_jsx("button", { className: "w-10 text-left", onClick: onBack ?? (() => nav(-1)), "aria-label": "Back", children: _jsx("span", { role: "img", "aria-hidden": true, className: "block", style: {
                        width: iconSize,
                        height: iconSize,
...
export function BottomNav() {
    ...
    return (_jsx("div", { className: "grid grid-cols-4 pt-2 pb-4", style: { backgroundColor: DECK_BG }, children: NAV_ITEMS.map((n) => {
