...
export default function App() {
    ...
    return (_jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "/send", element: _jsx(Send, {}) }), _jsx(Route, { path: "/receive", element: _jsx(Receive, {}) }), _jsx(Route, { path: "/swap", element: _jsx(Swap, {}) }), _jsx(Route, { path: "/search", element: _jsx(SearchScreen, {}) }), _jsx(Route, { path: "/token/:address", element: _jsx(TokenDetail, {}) }), _jsx(Route, { path: "/history", element: _jsx(History, {}) }), _jsx(Route, { path: "/settings", element: _jsx(Settings, {}) }), _jsx(Route, { path: "/settings/sites", element: _jsx(ConnectedSites, {}) }), _jsx(Route, { path: "/accounts", element: _jsx(Accounts, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }));
}
